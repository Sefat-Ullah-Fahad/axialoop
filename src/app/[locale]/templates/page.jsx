      ...
      <div className="max-w-4xl w-full text-center">
        ...
        >
          ...
          <p className="text-neutral-500 text-[13px] mt-8 leading-relaxed max-w-[420px] mx-auto">
            Within minutes you will receive a magic link via email to access the
            entire folder with{" "}
            <span className="text-neutral-200 font-medium italic">
              ALL templates and courses.
            </span>
          </p>
        </motion.div>
        ...
        >
          {benefits.map((item, index) => (
            <div
              key={index}
              className="flex items-center justify-center sm:justify-start space-x-3 text-neutral-400 text-sm tracking-wide"
            >
